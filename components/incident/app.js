define(['ui-router', 'ngStorage', 'ngCookies'], function () {
    ...
    var app = angular.module("app", ['ui.router', 'ngCookies', 'ngStorage', 'ngAnimate', 'ui.router' , 'ui.bootstrap',  'ui.grid', 'ui.grid.treeView', 'ui.grid.selection', , 'ui.grid.pagination' ,'oc.lazyLoad']);
